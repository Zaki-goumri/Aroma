 ...
 const heroVar={
  ...
  return (
    ...
    <motion.div variants={heroVar} initial="hidden" animate="visible"  className="flex md:justify md:gap-10 lg:flex-row items-center md:mx-[100px] my-10 flex-col gap-4 mb-0 ">
      <Image src="/aroma/piecemontee.jpg" alt="entremet" height={380} width={420} className="mb-4 md:px-0 px-6 rounded-[60px] "priority='false' />
    ...
    <img  src="/assets/bg.svg" alt="background" className="w-screen h-max relative top-0"  priority="false" />
