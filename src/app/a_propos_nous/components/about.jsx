...
const About = () => {
    return (
        ...
        <Image src="/aroma/aromaOut.jpg" alt="entremet" height={620} width={1000} className="rounded-[35px] md:px-3 px-4 md:rounded-[35px]" priority />
            <h1 className="text-4xl font-bhellloold text-aroma py-6">Qui sommes-nous </h1>
